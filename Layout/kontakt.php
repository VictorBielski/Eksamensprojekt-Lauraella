        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-lg-6 col-md-12 sm-12 mt-5">
                    ...
                    <p class="mt-3 text-center">Du er velkommen til at skrive til os vedrørende et produkt eller andet</p>
                    <form action="contact.php" method="POST" id="kontaktform">
                        <div class="row mt-3">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <input type="text" name="name" class="form-control mt-3 p-0" placeholder="Navn"
                                        required>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <input type="email" name="email" class="form-control mt-3 p-0" placeholder="Email"
                                        required>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <input type="text" name="subject" class="form-control mt-3 p-0" placeholder="Emne"
                                        required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group mt-3">
                                    <textarea type="text" name="message" class="form-control p-0" id="exampleFormControlTextarea1"
                                        placeholder="Din besked..." rows="3" required></textarea>
                                </div>
                            </div>
