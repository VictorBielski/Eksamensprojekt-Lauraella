...
<div class="container-fluid mt-2 view" id="bazar">

    <div class="row text-center justify-content-center mt-5" id="bazar_row">
        <div class="col-lg-6 col-md-12 col-sm-12">
            <h1 class="text-center mt-2">~ Laura Ella Bazar ~</h1>
            <p id="demo"></p>
        </div>
    </div>
