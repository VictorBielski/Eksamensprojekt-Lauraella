                ...
                <div class="col-sm-12 col-md-8 col-lg-4 underlay mt-5 mb-5">
                    ...
                    <form action="login.php" method="POST" class="text-center p-5" id="form">
                        ...
                        <div class="form-group">
                            <input type="text" id="defaultLoginFormEmail" name="un" class="form-control mb-4"
                                placeholder="Brugernavn">
                        </div>
                        <div class="form-group">
                            <input type="password" id="defaultLoginFormPassword" name="pw" class="form-control mb-4"
                                placeholder="Kodeord">
                        </div>
                        <div class="form-group">
