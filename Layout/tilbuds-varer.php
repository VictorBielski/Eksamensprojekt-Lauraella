        ...
        <div class="container w-75">
            ...
            <div class="row text-center justify-content-center">
                <div class="col-sm-12 col-md-8 col-lg-8 mt-5">
                    <h1>Her finder du alle varer som der er på tilbud i vores sortiment</h1>
                </div>
            </div>
...
$sql = "SELECT idGallery, titleGallery, descGallery, imgFullNameGallery, pages_id FROM galleri WHERE pages_id=3 ORDER BY orderGallery DESC LIMIT 18";
