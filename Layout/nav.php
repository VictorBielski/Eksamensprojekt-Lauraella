  ...
  <div class="container-fluid" id="socials">
    <div class="row">
      <div class="col-12 text-right">
        <ul>
          <a href="https://www.facebook.com/lauraelladragoer/" target="_blank"><i class="fab fa-facebook fa-2x mt-4 mr-1"
              id="facebook"></i></a>
          <a href="https://www.instagram.com/lauraelladragoer/?hl=da" target="_blank"><i class="fab fa-instagram fa-2x mt-4"
              id="instagram"></i></a>
        </ul>
      </div>
    </div>
